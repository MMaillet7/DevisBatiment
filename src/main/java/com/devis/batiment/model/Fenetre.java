...
/**
 * Fenêtre : ouverture rectangulaire (largeur × hauteur).
 * Dessinée en BLEU sur le plan.
 */
public class Fenetre extends Ouverture {
    ...
    public Fenetre(int idOuverture, double positionSurMur, double largeur, double hauteur) {
    ...
    @Override
    public TypeOuverture getTypeOuverture() { return TypeOuverture.FENETRE; }
